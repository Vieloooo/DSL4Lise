...
/*package*/ class RentalUnitType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RentalUnitType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_2m73md_a");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.type$j4AM;
